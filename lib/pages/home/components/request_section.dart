...
class RequestSection extends StatelessWidget {
  ...
  const RequestSection({Key key, @required this.isMobile, @required this.orgNames, @required this.requestButton}) : super(key: key);
  @override
  Widget build(BuildContext context) {
   // var dataRepo = locator<DataRepo>();
    ...
    TextStyle cTextStyle= Theme.of(context).textTheme.headline2.copyWith(color:Colors.black);
    TextStyle dTextStyle= Theme.of(context).textTheme.subtitle1.copyWith(color:Colors.black);
//https://maskcrusaders.org/delaware-receive-ppe
  //https://docs.google.com/forms/d/e/1FAIpQLSfy5UIMseILx9rBfX4bnvNMErSSrce5dVt60mPb1-iNGVhZag/viewform
        ...
        ? Container(
           // height: 820.0,
            child: Column(children: [
              ...
              Text("Is your organization in need of PPE?",style: cTextStyle,
              ),
              SizedBox(
                height: 30.0,
              ),
                  Text("We can 3D Print Face Shields and Ear-Savers for you",style: dTextStyle, ),
                       SizedBox(
                height: 30.0,
              ),
                      Center(
          ...
          Text("Other Resources",style: dTextStyle, ),
          SizedBox(height: 20.0, ),
                Container(
                height: 200.0,
                child: Row(
                  ...
                  children: [
                       Container(
                        ...
                        child: StylizedImageBox(
                          onPressed:  ()=>launch("https://persistshields.org/"),
    ...
    Container(
                        ...
                        height: tileH,
                        child: StylizedImageBox(
                          onPressed: ()=>launch("https://tinyurl.com/ybqyb4pz"),
                            bottomText: "Sewn Masks",
                            url: "https://scontent.fphl2-3.fna.fbcdn.net/v/t1.0-9/98565508_3430997256914607_3733525460215136256_o.jpg?_nc_cat=109&_nc_sid=825194&_nc_ohc=wzgkELLakh0AX9S9jKx&_nc_ht=scontent.fphl2-3.fna&oh=1819c8caf9e013fb5a525d8513479985&oe=5EF19342")
                            ),
                  ],
                ),
              ),
